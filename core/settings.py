...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-dev-only-secret-key')
...
CORS_ALLOW_ALL_ORIGINS = os.environ.get('DJANGO_CORS_ALLOW_ALL_ORIGINS', '1' if DEBUG else '0').strip().lower() in {'1', 'true', 't', 'yes', 'y'}
